...
function changeName() {
   ...
   document.querySelector('h1 > span').innerHTML = document.querySelector('#fname').value;
   document.querySelector('span + span').innerHTML = document.querySelector('#lname').value;
}
